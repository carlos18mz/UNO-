...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(503, 251);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(208, 72);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Iniciar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Menu_principal::button1_Click);
			// 
			// Menu_principal
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		baraja* obj_baraja = new baraja();
		Registro_jugadores^ objregistro = gcnew Registro_jugadores();
		objregistro->Show();
		this->Visible = false;
	}
	};
